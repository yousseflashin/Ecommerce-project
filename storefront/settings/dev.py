...
DATABASES = {  
    'default': dj_database_url.parse('postgres://storefront_2dre_user:RI1uq14s1pdRe1BwDOsRhpvSqBQMbalD@dpg-cppbho5ds78s73e5dang-a.oregon-postgres.render.com/storefront_2dre')
}  
